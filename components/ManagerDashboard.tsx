...
const ManagerDashboard: React.FC<ManagerDashboardProps> = ({ records }) => {
  ...
  const renderDetailView = (record: AttendanceRecord) => {
    ...
    const dataQuality = [
        { name: '인식됨', value: 92, color: '#3b82f6' },
        { name: '손실됨', value: 8, color: '#e5e7eb' }
    ];
    ...
    return (
      <div className="flex flex-col h-full bg-gray-50 overflow-y-auto">
        ...
        <div className="bg-white border-b border-gray-200 px-6 py-4 flex items-center gap-4">
            ...
            <span className="text-gray-500 text-sm">직원 관리</span>
            <span className="text-gray-300">/</span>
        ...
        <div className="p-6 max-w-7xl mx-auto w-full space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <div className="text-sm text-gray-500 flex items-center gap-3 mt-1">
                            <span>사번: {record.employeeId}</span>
                ...
                <div className="flex items-center gap-6 w-full md:w-auto">
                    ...
                    <div className="flex gap-6 border-r border-gray-200 pr-6 hidden lg:flex">
                        <div>
                            <div className="text-xs text-gray-500 font-medium uppercase">평균 심박수</div>
                        ...
                        <div>
                            <div className="text-xs text-gray-500 font-medium uppercase">위험 점수</div>
                            <div className={`text-xl font-bold ${isRisk ? 'text-red-600' : 'text-green-600'}`}>
                                {isRisk ? '위험' : '낮음'}
                            </div>
                        </div>
                         <div>
                            <div className="text-xs text-gray-500 font-medium uppercase">최근 7일</div>
                            <div className="text-xl font-bold text-gray-900">42시간</div>
                        </div>
                    </div>
            ...
            <div className="border-b border-gray-200 flex gap-8 px-2">
                <button className="pb-3 border-b-2 border-blue-600 text-blue-600 font-medium text-sm">위험 타임라인</button>
                <button className="pb-3 border-b-2 border-transparent text-gray-500 hover:text-gray-700 font-medium text-sm">근태 기록</button>
                <button className="pb-3 border-b-2 border-transparent text-gray-500 hover:text-gray-700 font-medium text-sm">알림</button>
                <button className="pb-3 border-b-2 border-transparent text-gray-500 hover:text-gray-700 font-medium text-sm">데이터 품질</button>
            </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex bg-gray-100 rounded-lg p-1">
                            <button className="px-3 py-1 text-xs font-medium text-gray-500">이전</button>
                            <button className="px-3 py-1 text-xs font-medium bg-white text-gray-900 shadow-sm rounded-md">오늘</button>
                            <button className="px-3 py-1 text-xs font-medium text-gray-500">다음</button>
                        </div>
                    </div>
                    ...
                    <div className="relative border-l-2 border-gray-200 ml-3 space-y-8 pb-4">
                        ...
                        <div className="relative pl-8">
                            ...
                            <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                                <div className="flex justify-between items-start mb-2">
                                    <h3 className="text-sm font-bold text-gray-900">출근 체크인</h3>
                                    <span className="px-2 py-0.5 bg-green-100 text-green-700 text-[10px] font-bold uppercase rounded">정상</span>
                                </div>
                                <div className="grid grid-cols-4 gap-4 text-xs">
                                    <div>
                                        <div className="text-gray-400 uppercase tracking-wider text-[10px]">체온</div>
                                        <div className="font-semibold text-gray-700">36.5°C</div>
                                    </div>
                                    <div>
                                        <div className="text-gray-400 uppercase tracking-wider text-[10px]">심박수</div>
                                        <div className="font-semibold text-gray-700">72 bpm</div>
                                    </div>
                                     <div>
                                        <div className="text-gray-400 uppercase tracking-wider text-[10px]">혈압</div>
                                        <div className="font-semibold text-gray-700">120/80</div>
                                    </div>
                                    <div>
                                        <div className="text-gray-400 uppercase tracking-wider text-[10px]">수분</div>
                                        <div className="font-semibold text-gray-700">좋음</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative pl-8">
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg border border-dashed border-gray-300 flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-sm font-bold text-gray-700">점심 휴식</h3>
                                    <p className="text-xs text-gray-400">시간: 45분</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className={`p-5 rounded-lg border shadow-sm ${isRisk ? 'bg-red-50 border-red-100' : 'bg-white border-gray-200'}`}>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="text-sm">
                                        <span className="block text-xs text-gray-500 uppercase">심박수</span>
                                        <span className={`font-mono font-bold ${isRisk ? 'text-red-700' : 'text-gray-900'}`}>{record.metrics.heartRate} bpm</span>
                                    </div>
                                    <div className="text-sm">
                                        <span className="block text-xs text-gray-500 uppercase">스트레스 레벨</span>
                         ...
                         <div className="relative pl-8 opacity-50">
                            ...
                            <div className="p-3 rounded-lg border border-gray-100 bg-white">
                                <h3 className="text-sm font-medium text-gray-400">예정된 근무 종료</h3>
                                <p className="text-xs text-gray-300">예정</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider">데이터 품질</h3>
                            <span className="px-2 py-0.5 bg-green-100 text-green-700 text-[10px] font-bold rounded">양호</span>
                        </div>
                            ...
                            <div className="flex-1 space-y-2">
                                <div>
                                    <div className="flex justify-between text-xs mb-1">
                                        <span className="text-gray-500">저조도</span>
                                ...
                                <div>
                                    <div className="flex justify-between text-xs mb-1">
                                        <span className="text-gray-500">모션 블러</span>
                    ...
                    <div className="bg-blue-50 p-5 rounded-xl border border-blue-100">
                        <div className="flex items-start gap-3 mb-3">
                            ...
                            <h3 className="text-sm font-bold text-blue-900">AI 건강 인사이트</h3>
                        </div>
                        <p className="text-xs text-blue-800 leading-relaxed">
                            {record.aiAnalysis || "창고 물류 직군을 위해 알고리즘 가중치가 조정되었습니다. 빠른 화물 처리 동작을 고려하여 '모션 블러' 엄격도가 15% 완화되었습니다."}
                        </p>
                        <div className="flex gap-2 mt-4">
                            <span className="px-2 py-1 bg-white border border-blue-200 text-blue-700 text-[10px] font-medium rounded">신뢰도: 높음</span>
                            <span className="px-2 py-1 bg-white border border-blue-200 text-blue-700 text-[10px] font-medium rounded">임계값: 0.65</span>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        <div className="px-5 py-4 border-b border-gray-100 flex justify-between items-center">
                            <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider">최근 근태</h3>
                            <button className="text-blue-600 text-xs font-medium hover:underline">전체 보기</button>
                        </div>
                        <table className="w-full text-left text-xs">
                            <thead className="bg-gray-50 text-gray-500">
                                <tr>
                                    <th className="px-5 py-2 font-medium">날짜</th>
                                    <th className="px-5 py-2 font-medium">출근</th>
                                    <th className="px-5 py-2 font-medium text-right">퇴근</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-gray-100">
                                <tr>
                                    <td className="px-5 py-3 text-gray-900 font-medium">10월 23일</td>
                                    <td className="px-5 py-3 text-gray-500">07:55</td>
                                    <td className="px-5 py-3 text-gray-500 text-right">17:05</td>
                                </tr>
                                <tr>
                                    <td className="px-5 py-3 text-gray-900 font-medium">10월 22일</td>
                                    <td className="px-5 py-3 text-gray-500">08:02</td>
                                    <td className="px-5 py-3 text-gray-500 text-right">17:00</td>
                                </tr>
                                <tr>
                                    <td className="px-5 py-3 text-gray-900 font-medium">10월 21일</td>
  ...
  return (
    <div className="h-full bg-gray-50 flex flex-col text-gray-900">
      ...
      <div className="bg-white border-b border-gray-200 px-8 py-5 flex justify-between items-center shadow-sm">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">근로자 안전 모니터링</h1>
          <p className="text-gray-500 text-sm">실시간 건강 상태 대시보드</p>
        </div>
        ...
        <div className="flex gap-4">
          <div className="bg-red-50 border border-red-100 px-4 py-2 rounded-lg flex items-center gap-3">
             ...
             <div>
                <span className="block text-xs font-bold text-red-800 uppercase">위험 알림</span>
          ...
          <div className="bg-green-50 border border-green-100 px-4 py-2 rounded-lg flex items-center gap-3">
             ...
             <div>
                <span className="block text-xs font-bold text-green-800 uppercase">정상 / 안전</span>
            ...
            <table className="w-full text-left border-collapse">
                <thead className="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">직원</th>
                        <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">시간</th>
                        <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">생체 지표 요약</th>
                        <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider text-right">조치</th>
                    </tr>
                </thead>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                    {record.status === 'RISK' ? (
                                        <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800 border border-red-200">
                                            <ShieldAlert className="w-3.5 h-3.5" /> 위험 감지
                                        </span>
                                    ) : (
                                ...
                                <td className="px-6 py-4">
                                    <div className="flex flex-col gap-1">
                                        <span className="text-xs text-gray-500 font-medium">
                                            심박수: <span className={record.metrics.heartRate > 100 ? "text-red-600 font-bold" : "text-gray-900"}>{record.metrics.heartRate} bpm</span> 
                                            <span className="text-gray-300 mx-2">|</span> 
                                            스트레스: <span className={record.metrics.stressLevel > 80 ? "text-red-600 font-bold" : "text-gray-900"}>{record.metrics.stressLevel}/100</span>
                                        </span>
                                        {record.aiAnalysis && (
